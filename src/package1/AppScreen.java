...
public class AppScreen {
    ...
    private static void createAndShowGUI() {
        ...
        Font noteFont = new Font("Times New Roman", Font.PLAIN, 15);
        ...
        JLabel cmdLabel = new JLabel("Enter a past or present date in MM/DD/YYYY: ");
        cmdLabel.setFont(timesFont);
        cmdLabel.setForeground(Color.BLACK);
        cmdLabel.setAlignmentX(Component.CENTER_ALIGNMENT);

        JLabel ruleLabel = new JLabel("NOTE: This calculator pinpoints dates on the internationally accepted Gregorian calendar, created in 1582. Please do not enter any years before 1582.");
        ruleLabel.setFont(noteFont);
